...
public class CommandExecutorInfo_v1_8_R2 implements CommandExecutorInfo{
    private final CommandSenderInfo_v1_8_R2 sender;
    private HashMap<String, CommandController.ParsedArgument> arguments;
    private final String fullString;
    private final String argString;
    
    public CommandExecutorInfo_v1_8_R2(CommandSenderInfo_v1_8_R2 sender, HashMap<String, CommandController.ParsedArgument> arguments, String fullString, String argString){
        this.sender = sender;
    ...
    public CommandSenderInfo_v1_8_R2 getSender(){
        return sender;
    }
}
