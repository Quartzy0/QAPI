...
public class CommandProviderImpl implements CommandProvider{
    ...
    public CommandSenderInfo createSenderInstance(){
        return new CommandSenderInfo_v1_16_R1();
    }
    ...
    private ArgumentBuilder<CommandListenerWrapper, ?> addBranch(ArgumentBuilder<CommandListenerWrapper, ?> commandBuilder, Node<?> nodeArg){
        ...
        if(nodeArg.getRequirement()!=null){
            argumentBuilder.requires(commandListenerWrapper -> {
                CommandSenderInfo_v1_16_R1 t = new CommandSenderInfo_v1_16_R1();
        ...
        if(nodeArg.getExecutor()!=null){
            argumentBuilder.executes(commandContext -> {
                CommandExecutorInfo_v1_16_R1 t = new CommandExecutorInfo_v1_16_R1();
    ...
    public com.mojang.brigadier.arguments.ArgumentType<?> toNMSArgument(ArgumentNode argumentType){
        switch(argumentType.getType()){
            ...
            case ENTITY:
                return net.minecraft.server.v1_16_R1.ArgumentEntity.a();
            case ENTITIES:
                return net.minecraft.server.v1_16_R1.ArgumentEntity.multipleEntities();
            case PLAYER:
                return net.minecraft.server.v1_16_R1.ArgumentEntity.c();
            case PLAYERS:
                return net.minecraft.server.v1_16_R1.ArgumentEntity.d();
            case BLOCK_POS:
