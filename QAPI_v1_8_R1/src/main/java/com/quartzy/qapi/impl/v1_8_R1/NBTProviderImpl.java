...
public class NBTProviderImpl implements NBTProvider{
    ...
    public NBTCompound getNBTFromItem(ItemStack itemStack){
        net.minecraft.server.v1_8_R1.ItemStack itemStack1 = CraftItemStack.asNMSCopy(itemStack);
    ...
    private NBTBase fromNMS(net.minecraft.server.v1_8_R1.NBTBase base){
        ...
        switch(base.getTypeId()){
            case 1:
                return new NBTByte(((net.minecraft.server.v1_8_R1.NBTNumber) base).f());
            case 2:
                return new NBTShort(((net.minecraft.server.v1_8_R1.NBTNumber) base).e());
            case 3:
                return new NBTInt(((net.minecraft.server.v1_8_R1.NBTNumber) base).d());
            case 4:
                return new NBTLong(((net.minecraft.server.v1_8_R1.NBTNumber) base).c());
            case 5:
                return new NBTFloat(((net.minecraft.server.v1_8_R1.NBTNumber) base).h());
            case 6:
                return new NBTDouble(((net.minecraft.server.v1_8_R1.NBTNumber) base).g());
            case 8:
