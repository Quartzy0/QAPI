...
import org.bukkit.craftbukkit.v1_9_R1.command.ProxiedNativeCommandSender;
...
public class CommandSenderInfo_v1_9_R1 implements CommandSenderInfo{
    private final CommandSender sender;
    private ICommandListener listener;
    private final Node<?> node;
    
    public CommandSenderInfo_v1_9_R1(CommandSender sender, Node<?> node){
        this.sender = sender;
