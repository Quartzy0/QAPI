...
public class NBTProviderImpl implements NBTProvider{
    ...
    public NBTCompound getNBTFromItem(ItemStack itemStack){
        net.minecraft.server.v1_9_R1.ItemStack itemStack1 = CraftItemStack.asNMSCopy(itemStack);
    ...
    private net.minecraft.server.v1_9_R1.NBTBase toNMSTag(NBTBase tag){
    ...
    private NBTBase fromNMS(net.minecraft.server.v1_9_R1.NBTBase base){
        if(base==null)return null;
        switch(base.getTypeId()){
            case 1:
                return new NBTByte(((net.minecraft.server.v1_9_R1.NBTTagByte) base).f());
            case 2:
                return new NBTShort(((net.minecraft.server.v1_9_R1.NBTTagShort) base).e());
            case 3:
                return new NBTInt(((net.minecraft.server.v1_9_R1.NBTTagInt) base).d());
            case 4:
                return new NBTLong(((net.minecraft.server.v1_9_R1.NBTTagLong) base).c());
            case 5:
                return new NBTFloat(((net.minecraft.server.v1_9_R1.NBTTagFloat) base).h());
            case 6:
                return new NBTDouble(((net.minecraft.server.v1_9_R1.NBTTagDouble) base).g());
            case 8:
