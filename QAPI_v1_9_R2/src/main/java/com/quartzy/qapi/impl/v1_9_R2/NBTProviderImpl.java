...
public class NBTProviderImpl implements NBTProvider{
    ...
    private net.minecraft.server.v1_9_R2.NBTBase toNMSTag(NBTBase tag){
    ...
    private NBTBase fromNMS(net.minecraft.server.v1_9_R2.NBTBase base){
        ...
        switch(base.getTypeId()){
            case 1:
                return new NBTByte(((net.minecraft.server.v1_9_R2.NBTTagByte) base).f());
            case 2:
                return new NBTShort(((net.minecraft.server.v1_9_R2.NBTTagShort) base).e());
            case 3:
                return new NBTInt(((net.minecraft.server.v1_9_R2.NBTTagInt) base).d());
            case 4:
                return new NBTLong(((net.minecraft.server.v1_9_R2.NBTTagLong) base).c());
            case 5:
                return new NBTFloat(((net.minecraft.server.v1_9_R2.NBTTagFloat) base).h());
            case 6:
                return new NBTDouble(((net.minecraft.server.v1_9_R2.NBTTagDouble) base).g());
            case 8:
