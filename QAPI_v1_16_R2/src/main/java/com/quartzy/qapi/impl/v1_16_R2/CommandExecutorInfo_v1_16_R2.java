...
public class CommandExecutorInfo_v1_16_R2 implements CommandExecutorInfo{
    private CommandSenderInfo_v1_16_R2 senderInfo;
    ...
    public void setCommandContext(CommandContext<CommandListenerWrapper> commandContext){
        ...
        this.senderInfo = new CommandSenderInfo_v1_16_R2();
    ...
    public Object getArgument(String argumentName, ArgumentType type){
        ...
        switch(type){
            ...
            case ITEM_PREDICATE:
                ...
                Predicate<net.minecraft.server.v1_16_R2.ItemStack> itemStackPredicate = itemPredicate.create(commandContext);
