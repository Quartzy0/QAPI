...
public class CommandExecutorInfo_v1_11_R1 implements CommandExecutorInfo{
    private final CommandSenderInfo_v1_11_R1 sender;
    private HashMap<String, CommandController.ParsedArgument> arguments;
    private final String fullString;
    private final String argString;
    
    public CommandExecutorInfo_v1_11_R1(CommandSenderInfo_v1_11_R1 sender, HashMap<String, CommandController.ParsedArgument> arguments, String fullString, String argString){
        this.sender = sender;
    ...
    public CommandSenderInfo_v1_11_R1 getSender(){
        return sender;
    }
}
