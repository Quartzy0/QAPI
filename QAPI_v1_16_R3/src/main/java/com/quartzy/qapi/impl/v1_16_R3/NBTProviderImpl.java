...
public class NBTProviderImpl implements NBTProvider{
    ...
    public net.minecraft.server.v1_16_R3.NBTBase toNMSTag(NBTBase tag){
    ...
    public NBTBase fromNMS(net.minecraft.server.v1_16_R3.NBTBase base){
        if(base==null)return null;
        switch(base.getTypeId()){
            case CraftMagicNumbers.NBT.TAG_BYTE:
                return new NBTByte(((net.minecraft.server.v1_16_R3.NBTNumber) base).asByte());
            case CraftMagicNumbers.NBT.TAG_SHORT:
                return new NBTShort(((net.minecraft.server.v1_16_R3.NBTNumber) base).asShort());
            case CraftMagicNumbers.NBT.TAG_INT:
                return new NBTInt(((net.minecraft.server.v1_16_R3.NBTNumber) base).asInt());
            case CraftMagicNumbers.NBT.TAG_LONG:
                return new NBTLong(((net.minecraft.server.v1_16_R3.NBTNumber) base).asLong());
            case CraftMagicNumbers.NBT.TAG_FLOAT:
                return new NBTFloat(((net.minecraft.server.v1_16_R3.NBTNumber) base).asFloat());
            case CraftMagicNumbers.NBT.TAG_DOUBLE:
                return new NBTDouble(((net.minecraft.server.v1_16_R3.NBTNumber) base).asDouble());
            case CraftMagicNumbers.NBT.TAG_STRING:
            ...
            case CraftMagicNumbers.NBT.TAG_LIST:
                ...
                for(net.minecraft.server.v1_16_R3.NBTBase nbtBase : nbtList){
