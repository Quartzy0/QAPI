...
public class NBTProviderImpl implements NBTProvider{
    ...
    private net.minecraft.server.v1_12_R1.NBTBase toNMSTag(NBTBase tag){
    ...
    public NBTBase fromNMS(net.minecraft.server.v1_12_R1.NBTBase base){
        ...
        switch(base.getTypeId()){
            case CraftMagicNumbers.NBT.TAG_BYTE:
                return new NBTByte(((net.minecraft.server.v1_12_R1.NBTTagByte) base).g());
            case CraftMagicNumbers.NBT.TAG_SHORT:
                return new NBTShort(((net.minecraft.server.v1_12_R1.NBTTagShort) base).f());
            case CraftMagicNumbers.NBT.TAG_INT:
                return new NBTInt(((net.minecraft.server.v1_12_R1.NBTTagInt) base).e());
            case CraftMagicNumbers.NBT.TAG_LONG:
                return new NBTLong(((net.minecraft.server.v1_12_R1.NBTTagLong) base).d());
            case CraftMagicNumbers.NBT.TAG_FLOAT:
                return new NBTFloat(((net.minecraft.server.v1_12_R1.NBTTagFloat) base).i());
            case CraftMagicNumbers.NBT.TAG_DOUBLE:
                return new NBTDouble(((net.minecraft.server.v1_12_R1.NBTTagDouble) base).asDouble());
            case CraftMagicNumbers.NBT.TAG_STRING:
    ...
    private long[] getLongArray(NBTTagLongArray array){
        try{
            if(longField==null){
                    longField = NBTTagLongArray.class.getDeclaredField("b");
                    longField.setAccessible(true);
            }
            return (long[]) longField.get(array);
