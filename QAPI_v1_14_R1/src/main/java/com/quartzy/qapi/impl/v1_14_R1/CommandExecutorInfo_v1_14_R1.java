...
public class CommandExecutorInfo_v1_14_R1 implements CommandExecutorInfo{
    private CommandSenderInfo_v1_14_R1 senderInfo;
    ...
    public void setCommandContext(CommandContext<CommandListenerWrapper> commandContext){
        ...
        this.senderInfo = new CommandSenderInfo_v1_14_R1();
    ...
    public Object getArgument(String argumentName, ArgumentTypeEnum type){
        ...
        switch(type){
            ...
            case ITEM_PREDICATE:
                ...
                Predicate<net.minecraft.server.v1_14_R1.ItemStack> itemStackPredicate = itemPredicate.create(commandContext);
