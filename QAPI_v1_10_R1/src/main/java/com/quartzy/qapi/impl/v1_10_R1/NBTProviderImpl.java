...
public class NBTProviderImpl implements NBTProvider{
    ...
    public NBTCompound getNBTFromItem(ItemStack itemStack){
        net.minecraft.server.v1_10_R1.ItemStack itemStack1 = CraftItemStack.asNMSCopy(itemStack);
    ...
    private net.minecraft.server.v1_10_R1.NBTBase toNMSTag(NBTBase tag){
    ...
    private NBTBase fromNMS(net.minecraft.server.v1_10_R1.NBTBase base){
        ...
        switch(base.getTypeId()){
            case 1:
                return new NBTByte(((net.minecraft.server.v1_10_R1.NBTTagByte) base).g());
            case 2:
                return new NBTShort(((net.minecraft.server.v1_10_R1.NBTTagShort) base).f());
            case 3:
                return new NBTInt(((net.minecraft.server.v1_10_R1.NBTTagInt) base).e());
            case 4:
                return new NBTLong(((net.minecraft.server.v1_10_R1.NBTTagLong) base).d());
            case 5:
                return new NBTFloat(((net.minecraft.server.v1_10_R1.NBTTagFloat) base).i());
            case 6:
                return new NBTDouble(((net.minecraft.server.v1_10_R1.NBTTagDouble) base).h());
            case 8:
